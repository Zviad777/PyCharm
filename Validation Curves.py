...
train_sizes, train_scores, test_scores =\
    learning_curve(estimator=pipe_lr,
                   ...
                   cv=10,
                   n_jobs=1)
print("X", X_train.shape, "train_sizes", train_sizes, "train_scores", train_scores, "test_scores", test_scores)
...
train_scores, test_scores = validation_curve(
    ...
    cv=10)
print("train_scores", train_scores, "test_scores", test_scores)
